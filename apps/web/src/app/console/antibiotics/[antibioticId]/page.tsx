...
export default async function AntibioticDetailPage({
  ...
  return (
    <Shell profile={profile} current="/console/antibiotics">
      <PageHeading
      ...
      <div className="space-y-6">
        ...
        <nav className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm">
          <Link href="/console/antibiotics" className="font-medium text-brand-700">
            ← All agents
          </Link>
          <Link href="/console/antibiogram" className="text-ink-muted hover:text-ink">
            Full antibiogram
          </Link>
        </nav>
